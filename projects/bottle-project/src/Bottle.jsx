      ...
      <div className="border border-gray-100">
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex items-center justify-between">
            <p>Prices: {price}$</p>
            <button className="py-1 px-3 bg-sky-500 text-white rounded text-sm font-semibold hover:bg-transparent hover:text-sky-500 transition-all hover:border hover:border-sky-500 border cursor-pointer">
              Buy Now
            </button>
