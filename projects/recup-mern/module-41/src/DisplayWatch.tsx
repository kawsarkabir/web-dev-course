export default function DisplayWatch({ productItems, handleClick }) {
    return (
        <div class="w-96 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="p-8 rounded-t-lg" src={productItems?.image} alt="product image" className="w-full h-52 object-cover" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{productItems?.brand}</h5>
                </a>
